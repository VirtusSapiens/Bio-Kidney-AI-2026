...
INTERP={"vasc":"Red vascular optimizada con CCO v7, 1448 segmentos cumpliendo ley de Murray. Presion 13 kPa fisiologica. Cobertura 100% sin isquemia.","o2":"O2 module: withdrawn (see preprint v4)","ipsc":"iPSCs diferenciadas: podocitos 100%, asa Henle 100%, tubulo proximal 100%. Riesgo teratoma bajo (OCT4 menor 0.1%).","swift":"Co-SWIFT 60 Pa en rango 40-80 Pa. Viabilidad 98% = techo (clamp) de la funcion objetivo [20,98], NO optimo computado. WSS 5.6 dyn/cm2 = punto de operacion de entrada, NO resultado validado. (ver preprint v4 §3.5)","filtro":"TFG 115.4 mL/min reportada como feasibility check bajo escala calibrada (no prediccion geometrica). Ver preprint v4.","reabs":"Reabsorcion tubular EN CUARENTENA: el modulo no compila; cifras retiradas. Ver preprint v4."}
DATOS=[("VASCULARIZACION CCO v7","vasc",[("Segmentos Murray:","1,448"),("Cumplimiento CCO:","100%"),("Presion entrada:","13 kPa"),("Cobertura red:","100%")]),("OXIGENACION O2","o2",[("Estado:","RETIRADO"),("Ref:","preprint v4")]),("DIFERENCIACION iPSC","ipsc",[("Pureza podocitos:","100%"),("Pureza asa Henle:","100%"),("Pureza tubulo px:","100%"),("Riesgo teratoma:","BAJO")]),("BIOIMPRESION Co-SWIFT","swift",[("Presion extrusion:","60 Pa"),("Viabilidad (clamp techo):","98%"),("WSS (input op.):","5.6 dyn"),("Soluciones Pareto:","100")]),("FILTRACION GLOMERULAR","filtro",[("TFG (feas. check):","115.4 mL/min"),("Presion Starling:","POSITIVA"),("Slit diaphragm:","INTEGRO"),("Flujo capilar:","LAMINAR")]),("REABSORCION TUBULAR","reabs",[("Estado:","EN CUARENTENA"),("Ref:","preprint v4")])]
