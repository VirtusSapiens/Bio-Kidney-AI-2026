...
SEMILLA       = 42
PUNTOS_SPLINE = 10
R_MIN         = 8e-6     # 8 µm — por debajo de arteriola aferente real
...
# Parámetros adaptativos v7
N_SEMILLAS_DEMANDA = 1000   # subió de 400 a 1000
RADIO_COBERTURA    = 0.005  # bajó de 8mm a 5mm — más exigente
MAX_ITERACIONES    = 4000   # subió de 2000 a 4000
LONGITUD_BASE      = 0.006
...
def visualizar(segs, demanda, ruta):
    ...
    plt.title(
        'Bio-Kidney AI 2026 — Vascularización Completa CCO v7\n'
        f'Arterial: {sa} seg  ·  Venoso: {sv} seg  '
        f'·  Colector: {sc} seg  ·  '
        f'R_min={r_min_f:.1f} µm  ·  '
        f'Murray α={ALPHA} 100%  ·  '
...
if __name__ == "__main__":
    ...
    print("\n" + "═"*60)
    print("  BIO-KIDNEY AI 2026 — GENERADOR CCO v7")
    print("  1000 puntos demanda · R_min=8µm · Murray 100%")
    print("  Cobertura 5mm · 4000 iteraciones adaptativas")
    print("═"*60)

    print("\n  Generando 1000 puntos de demanda...")
    ...
    exportar(todos, SALIDA + "arbol_vascular_cco_v7.csv")
    visualizar(todos, demanda,
               SALIDA + "arbol_vascular_cco_v7.png")
