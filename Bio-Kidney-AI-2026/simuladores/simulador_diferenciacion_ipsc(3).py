...
k = {
    # Tasas de diferenciación (día⁻¹) — aumentadas para conversión eficiente
    "k_iPSC_to_IM":   1.20,   # iPSC → Mesodermo Intermedio (Wnt potente)
    "k_IM_to_NPC":    0.90,   # IM → NPC
    "k_NPC_to_PODO":  0.45,   # NPC → Podocitos
    "k_NPC_to_PCT":   0.55,   # NPC → Células Tubulares Prox.
    "k_NPC_to_IEC":   0.35,   # NPC → Células Endoteliales
